...
// edits honest (gate reaches the keep and EVERY plaza/hall REGION, at least
// 2 distinct gate→keep routes, every open cell reachable from the gate as a
// single connected component, each hall has exactly 2 doorways).
//
// Legend:
...
export const WARD_MAP: readonly string[] = [
  ...
  '#...#...#...#......#......#...#...##', // 11
  '###.###.#######.#.#.###.#.###.#.####', // 12
  '#....#.........#....#...##..#.....##', // 13 — (13,10) opened: connects the (13,11-14)/(14,13)/(15,13-16)/(16,15)/(17,15) alcove to the west corridor without touching the keep (Castle Ward fast-follow: orphaned-pocket fix, see ward.test.ts)
  '#.#######.###.#####.#.#.#.#.###.####', // 14
  '#.##HHH##...#....#.....#....#.....##', // 15
  '####HHH##.#####.KKKK###.#.#.###.#.##', // 16
  '#...HHH...#...#.KKKK..#...#...###..G', // 17
