...
const KEYBINDS: [string, string][] = [
  ...
  ['SKY', 'Follow Haven’s eastern lanterns: lower bounce → drone bounce → midair RMB grapple'],
  ['CASTLE', 'Climb the gate stair, roof galleries and keep; F reads the three ward records'],
  ['ATLANTIS', 'Q/E explores the flooded rooms; brass airbells replenish breath; F reads lost charts'],
