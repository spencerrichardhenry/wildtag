...
PROMPT = 'redo all the assets using blender mcp instead of just winging it in 3.js. keep the cutesy vibe but make it much much more immersive. add several things to eat for each stage. besides the planets stage.'
